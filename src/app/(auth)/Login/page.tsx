...
//             <button className='text-white bg-[#FB2E86] w-[432px] h-[52px] msm:w-[300px] ssm:w-[300px] xsm:w-[240px]'>Log In</button>
//             <Link href={"/Signup"}>Donot have an account Sign up</Link>
//         </div>
//         </section>
//     </section>
//   )
