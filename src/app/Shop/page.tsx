...
function Page() {
  ...
  const getProductCardClasses = (category: string) => {
    if (category === 'Sofa') {
      return 'w-full max-w-[570px] flex justify-center items-center flex-col bg-[#F2F0FF] hover:bg-[#EBF4F3]';
    }
    return 'w-[270px] flex justify-center items-center flex-col bg-[#F2F0FF] hover:bg-[#EBF4F3]';
  };
...
//    const [ChairsTheme,setChairsTheme] = useState<ProductsDetails[]>([]);
//    const [Loading,setLoading] = useState(false);
//    useEffect(()=>{
//     async function filterbychairs(){
//       setLoading(true);
//       const fetchhairs:ProductsDetails[] = await client.fetch(`*[_type=="product" && category=="Chair" ]{
//   _id,
//   name,
//   image,
//   price,
...
//   stockLevel,
// }`)
// console.log("fetch chairs",fetchhairs)
// setLoading(false)
// setproduct(fetchhairs)
//     }
//    },[]);
